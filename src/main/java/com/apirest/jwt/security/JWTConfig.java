...
import com.apirest.jwt.service.DetalheUsuarioServiceImpl;
...
public class JWTConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable().authorizeRequests()
                ...
                .antMatchers(HttpMethod.POST, "/api/user/salvar").permitAll()
                .antMatchers(HttpMethod.GET, "/api/user/validarSenha").permitAll()
